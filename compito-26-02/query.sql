...
--4--
SELECT SUM(Freight)  as TotaleTrasporto FROM Orders;

--5--
SELECT CustomerID, SUM(Freight) as TotTrasportoBOTTM FROM Orders WHERE CustomerID = 'BOTTM' GROUP BY CustomerID ;
...
--10--
SELECT CategoryID, SUM(ProductId) as TotaleProdotti FROM Products GROUP BY CategoryID;
